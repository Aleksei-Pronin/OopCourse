...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Длина вектора " + vector2 + " = " + vector2.getVectorLength() + "\n");

        System.out.println(vector1.equals(vector3) ? "Векторы " + vector1 + " и " + vector3 + " равны\n" : "Векторы " + vector1 + " и " + vector3 + " не равны\n");

        System.out.println("Изменим вторую координату вектора " + vector4);
        vector4.setCoordinate(5, 1);
        ...
        vector6.scalarMultiplication(3);
        vector6.reverseVector();
        System.out.println("Результат " + vector6 + "\n");
